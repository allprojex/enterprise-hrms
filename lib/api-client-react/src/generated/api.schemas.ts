...
export interface Organization {
  /** Internal primary key. The security boundary every tenant-owned row references. Immutable. */
  id: number;
  /** Immutable, globally unique tenant identity. Quote this in support, maintenance and change requests. Generated by the database, never client-supplied, never changed. */
  tenantUuid: string;
  /** Display name only. Never a security boundary; renaming changes nothing about data ownership. */
  name: string;
  /** Human-readable tenant code. Unique; immutable after creation. */
  slug: string;
...
export interface CreateOrganizationInput {
  ...
  name: string;
  /**
     * Tenant code. Lowercase letters, digits and single hyphens; unique across the platform; immutable after creation.
     * @minLength 2
     * @maxLength 63
...
/**
 * The slug (tenant code), id and tenantUuid are immutable and are not accepted here.
 */
...
export interface OrganizationStatusChangeInput {
  /**
     * Must equal the target organization's slug (tenant code). A typed confirmation of the target.
     * @minLength 1
     */
  confirmSlug: string;
  /**
     * Why the status is being changed. Recorded in the audit event.
     * @maxLength 2000
     */
  reason?: string;
}

export type TenantIdentityOrganizationType = typeof TenantIdentityOrganizationType[keyof typeof TenantIdentityOrganizationType];


export const TenantIdentityOrganizationType = {
  business: 'business',
  church: 'church',
  ngo: 'ngo',
  school: 'school',
...
export type TenantIdentityOrganizationStatus = typeof TenantIdentityOrganizationStatus[keyof typeof TenantIdentityOrganizationStatus];


export const TenantIdentityOrganizationStatus = {
  active: 'active',
  suspended: 'suspended',
  trial: 'trial',
} as const;

export type TenantIdentityOrganization = {
  id: number;
  tenantUuid: string;
  slug: string;
  name: string;
  type: TenantIdentityOrganizationType;
  status: TenantIdentityOrganizationStatus;
  createdAt: string;
};

/**
 * Release identity of the process that served this request.
 */
export type TenantIdentityRuntime = {
  environment: string;
  appVersion: string;
  /** @nullable */
...
export type TenantIdentityDomainsItemDomainType = typeof TenantIdentityDomainsItemDomainType[keyof typeof TenantIdentityDomainsItemDomainType];


export const TenantIdentityDomainsItemDomainType = {
  platform_subdomain: 'platform_subdomain',
  custom_domain: 'custom_domain',
} as const;

export type TenantIdentityDomainsItemStatus = typeof TenantIdentityDomainsItemStatus[keyof typeof TenantIdentityDomainsItemStatus];


export const TenantIdentityDomainsItemStatus = {
  pending: 'pending',
  active: 'active',
  disabled: 'disabled',
} as const;

export type TenantIdentityDomainsItem = {
  id: number;
  hostname: string;
  domainType: TenantIdentityDomainsItemDomainType;
  status: TenantIdentityDomainsItemStatus;
  isPrimary: boolean;
};

export type TenantIdentityModulesItemStatus = typeof TenantIdentityModulesItemStatus[keyof typeof TenantIdentityModulesItemStatus];


export const TenantIdentityModulesItemStatus = {
  active: 'active',
  beta: 'beta',
  hidden: 'hidden',
...
export type TenantIdentityModulesItem = {
  key: string;
  name: string;
  status: TenantIdentityModulesItemStatus;
  enabled: boolean;
};

export type TenantIdentityInstallationEnvironmentType = typeof TenantIdentityInstallationEnvironmentType[keyof typeof TenantIdentityInstallationEnvironmentType];


export const TenantIdentityInstallationEnvironmentType = {
...
export type TenantIdentityInstallationHostingModel = typeof TenantIdentityInstallationHostingModel[keyof typeof TenantIdentityInstallationHostingModel];


export const TenantIdentityInstallationHostingModel = {
  shared: 'shared',
...
export type TenantIdentityInstallationStatus = typeof TenantIdentityInstallationStatus[keyof typeof TenantIdentityInstallationStatus];


export const TenantIdentityInstallationStatus = {
  active: 'active',
  inactive: 'inactive',
  decommissioned: 'decommissioned',
} as const;

export interface TenantIdentityInstallation {
  id: number;
  installationKey: string;
  name: string;
  environmentType: TenantIdentityInstallationEnvironmentType;
  hostingModel: TenantIdentityInstallationHostingModel;
  /** @nullable */
  ...
  status: TenantIdentityInstallationStatus;
  linkedAt: string;
}

/**
 * feature = a platform capability enabled for selected tenants (Level 2); tenant_extension = a controlled tenant-specific behaviour (Level 3).
 */
export type FeatureFlagStateLevel = typeof FeatureFlagStateLevel[keyof typeof FeatureFlagStateLevel];


export const FeatureFlagStateLevel = {
  feature: 'feature',
...
export interface TenantIdentity {
  organization: TenantIdentityOrganization;
  /** Release identity of the process that served this request. */
  runtime: TenantIdentityRuntime;
  installations: TenantIdentityInstallation[];
  domains: TenantIdentityDomainsItem[];
  modules: TenantIdentityModulesItem[];
...
export interface SetFeatureFlagInput {
  enabled: boolean;
  /**
     * Why this flag is being changed for this tenant. Recorded in the audit event.
     * @minLength 1
     * @maxLength 2000
     */
  reason: string;
