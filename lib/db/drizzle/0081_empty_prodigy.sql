...
ALTER TABLE "vehicle_request_approvals" ADD CONSTRAINT "vehicle_request_approvals_request_id_vehicle_requests_id_fk" FOREIGN KEY ("request_id") REFERENCES "public"."vehicle_requests"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
