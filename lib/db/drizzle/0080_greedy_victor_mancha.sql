...
CREATE UNIQUE INDEX "vehicles_org_asset_unique" ON "vehicles" USING btree ("organization_id","asset_id") WHERE "vehicles"."asset_id" is not null;--> statement-breakpoint
CREATE INDEX "vehicles_org_status_idx" ON "vehicles" USING btree ("organization_id","status");--> statement-breakpoint
CREATE INDEX "vehicles_org_branch_idx" ON "vehicles" USING btree ("organization_id","branch_id");--> statement-breakpoint
