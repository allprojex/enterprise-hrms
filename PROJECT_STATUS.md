...
3. No user registration/creation UI anywhere — limits realistic multi-user testing. Targeted by W10 (invitation-first admin user management) — corrected from an earlier reference to W7, which is Master Data Management, not user management.
